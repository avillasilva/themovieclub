...
-- INSERT INTO REVIEW (title, author, content, is_public) VALUES('Post 1 de Luiz', 'Luiz Souza', 'Content Post 1', true);
-- INSERT INTO REVIEW (title, author, content, is_public) VALUES('Post 2 de Luiz', 'Luiz Souza', 'Content Post 1', true);
-- INSERT INTO REVIEW (title, author, content, is_public) VALUES('Post 3 de Luiz', 'Luiz Souza', 'Content Post 1', true);

-- INSERT INTO REVIEW (title, author, content, is_public) VALUES('Post 1 de Luiz', 'Amanda Albuquerque', 'Content Post 1', true);
-- INSERT INTO REVIEW (title, author, content, is_public) VALUES('Post 2 de Luiz', 'Amanda Albuquerque', 'Content Post 1', true);
-- INSERT INTO REVIEW (title, author, content, is_public) VALUES('Post 3 de Luiz', 'Amanda Albuquerque', 'Content Post 1', true);
