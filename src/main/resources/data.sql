...
INSERT INTO REVIEW (title, author_id, content) VALUES('Review 1 - Luiz', 1, 'Content');
INSERT INTO REVIEW (title, author_id, content) VALUES('Review 2 - Luiz', 1, 'Content');
INSERT INTO REVIEW (title, author_id, content) VALUES('REview 3 - Luiz', 1, 'Content');

INSERT INTO REVIEW (title, author_id, content) VALUES('Review 1 - Amanda', 2, 'Content');
INSERT INTO REVIEW (title, author_id, content) VALUES('Review 2 - Amanda', 2, 'Content');
INSERT INTO REVIEW (title, author_id, content) VALUES('REview 3 - Amanda', 2, 'Content');

INSERT INTO REVIEW (title, author_id, content) VALUES('Review 1 - Junior', 3, 'Content');
INSERT INTO REVIEW (title, author_id, content) VALUES('Review 2 - Junior', 3, 'Content');
INSERT INTO REVIEW (title, author_id, content) VALUES('REview 3 - Junior', 3, 'Content');
