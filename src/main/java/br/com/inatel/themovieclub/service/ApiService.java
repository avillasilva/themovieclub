...
public class ApiService {
    ...
    public MovieList searchMovieByTitle(String query, String page) {
        ...
        MovieList movieList = restTemplate
                .getForObject("https://api.themoviedb.org/3/search/movie?api_key=48ee1fab81a490fcf35669de4869886f&language=en-US&query="
                        + query + "&page=" + page + "&include_adult=false", MovieList.class);
        return movieList;
    }
