...
public class MovieListController {
	...
	@PutMapping("/{id}")
	@Transactional
	public ResponseEntity<MovieListDto> changeName(Authentication authentication, @PathVariable Long id, @RequestBody @Valid MovieListUpdateForm form) {
		User user = (User) authentication.getPrincipal();
		Optional<MovieList> optional = movieListRepository.findById(id);
	...
	@Transactional
	public ResponseEntity<MovieListDto> addMovie(Authentication authentication, @PathVariable Long movieListId, @RequestBody MovieForm form) {
		User user = (User) authentication.getPrincipal();
	...
	@Transactional
	public ResponseEntity<MovieListDto> removeMovie(Authentication authentication, @PathVariable Long movieListId, @PathVariable Long movieId) {
		User user = (User) authentication.getPrincipal();
	...
	@Transactional
	public ResponseEntity<MovieListDto> notWatched(Authentication authentication, @PathVariable Long movieListId, @PathVariable Long movieId) {
		User user = (User) authentication.getPrincipal();
		Optional<MovieList> movieListOptional = movieListRepository.findById(movieListId);
		Optional<Movie> movieOptional = movieRepository.findById(movieId);
