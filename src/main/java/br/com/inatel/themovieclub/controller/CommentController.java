...
public class CommentController {
    ...
    public ResponseEntity<CommentDto> create(Authentication authentication, @RequestBody @Valid CommentForm form,
            @PathVariable Long reviewId, UriComponentsBuilder uriBuilder) {
